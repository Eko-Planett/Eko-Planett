...
class PageHeader extends HTMLElement {
  connectedCallback() {
    this.innerHTML = '<div class="logo"><img src="/images/EkoPlanett.png" alt="Eko Planett Logo" width="63" height="63"/><br></div><div class="navbar"><div class="dropdown"><button class="dropbtn">Menu</button><div class="dropdown-content"><a href="/">Home</a><a href="/tips">Tips</a><a href="/jokes">Jokes</a></div></div></div><br><br><br>';
  }
}
